...
\begin{figure}[Dron y sensorización]{FIG:DronRaspi}{Dron sin ningún añadido y sistema de sensorización con Raspberry.}
  ...
  \subfigure[SBFIG:DRONVIRGEN]{Dron base.}{\image{0.3\textwidth}{}{dronVirgen}} \quad
  \subfigure[SBFIG:RASPISENSOR]{Raspberry con sensor}{\image{0.3\textwidth}{}{RaspiSensor}}
