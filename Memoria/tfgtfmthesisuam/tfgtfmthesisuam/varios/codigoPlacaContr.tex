...
\PythonCode[COD:CODIGOPYMAINPLACACONTR]{Main placa controladora TCP.}{Se muestra el main despues de incluir todas las librerias oportunas.}{mainPlacaControladora.py}{11}{61}{11}
